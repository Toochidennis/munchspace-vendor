...
export default function StorePreview() {
  ...
  const saveStoreImage = () => {
    ...
    setImageError("");
    alert("Store image saved successfully!");
  };
              ...
              <div className="absolute inset-0 top-12 bottom-12 left-6 right-6 rounded-3xl overflow-hidden bg-white">
                ...
                <div className="flex gap-4 px-4 py-3 border-b border-gray-200">
                  <Button
                    variant="secondary"
                    size="sm"
                    className="rounded-full bg-munchprimary text-white"
                  >
                    All
                  </Button>
                      ...
                      <div className="flex-1">
                        ...
                        <div className="flex items-center justify-between mt-2">
                          ...
                          <div className="flex items-center gap-2">
                            ...
                            <Button
                              size="sm"
                              className="rounded-full bg-munchprimary hover:munchprimaryDark text-white w-8 h-8"
                            >
                              +
                            </Button>
                          </div>
