          ...
          <TabsContent value="kyc" className="mt-5 space-y-12">
            <div className="min-h-screen bg-white text-gray-900">
              <div className="max-w-4xl mx-auto p-8 space-y-12">
                  ...
                  <CardContent>
                    <label className="block">
                      <input
                        ...
                        className="hidden"
                      />
                      <Button className="bg-orange-500 hover:bg-munchprimary text-white rounded-full">
                ...
                {/* Submit Button */}
                <div className="flex justify-end">
                  <Button className="bg-orange-500 hover:bg-munchprimary text-white rounded-full px-12 py-6 text-lg">
                    Submit
                  </Button>
                </div>
              </div>
